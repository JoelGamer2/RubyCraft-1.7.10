...
public class Cambiador_de_Texturas {
	...
	public static void Texturas_Navidad(){
		...
		RubyCraft.Bloqueestructural.setBlockTextureName(Navidad + "Bloqueestructural");
	...
	public static void Texturas_Normales(){
	    ...
	    RubyCraft.Bloqueestructural.setBlockTextureName(normal + "Bloqueestructural"); 
	...
	public static void Texturas_Hallowen(){
	    ...
	    RubyCraft.Bloqueestructural.setBlockTextureName(HalloWen + "Bloqueestructural"); 
