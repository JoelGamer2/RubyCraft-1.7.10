...
public abstract class BaseMobs extends EntityCreature implements IMob
{
    private static final String __OBFID = "CL_00001692";

    public BaseMobs(World p_i1738_1_)
    {
        super(p_i1738_1_);
     ...
     */
    public boolean attackEntityFrom(DamageSource source, float dano)
    {
