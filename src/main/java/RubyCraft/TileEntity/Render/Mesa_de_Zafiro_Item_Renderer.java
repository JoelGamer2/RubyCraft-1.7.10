...
public class Mesa_de_Zafiro_Item_Renderer implements IItemRenderer{

	private TileEntity tile;
	private TileEntitySpecialRenderer render;
	
	public Mesa_de_Zafiro_Item_Renderer(TileEntity tile, TileEntitySpecialRenderer render) {
		super();
		this.tile = tile;
		this.render = render;
	}
