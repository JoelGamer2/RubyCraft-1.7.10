...
public class Transformador_de_Losas_a_BloquesShapedRecipes implements IRecipe
{
    ...
    public Transformador_de_Losas_a_BloquesShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public Transformador_de_Losas_a_BloquesShapedRecipes func_92100_c()
    {
