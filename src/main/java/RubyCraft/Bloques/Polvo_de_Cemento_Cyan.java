...
public class Polvo_de_Cemento_Cyan extends BlockFalling{


    public Polvo_de_Cemento_Cyan(Material material){
    ...
    public void tick(World world, int x, int y, int z) {
    		...
    		world.setBlock(x, y, z, Cementos_Bases.Cemento_Endurecido_Cyan);
    	}
