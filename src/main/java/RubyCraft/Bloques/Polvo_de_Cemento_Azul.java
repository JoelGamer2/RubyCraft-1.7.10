...
public class Polvo_de_Cemento_Azul extends BlockFalling{



    public Polvo_de_Cemento_Azul(Material material){
    ...
    public void tick(World world, int x, int y, int z) {
    		...
    		world.setBlock(x, y, z, Cementos_Bases.Cemento_Endurezido_Azul);
    	}
