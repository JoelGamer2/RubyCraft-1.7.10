...
public class botasdeZafiro extends ItemArmor {

	public botasdeZafiro(ArmorMaterial armormaterial, int renderIdex, int armorType) {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack stack){
		...
		if(stack.getItem() == RubyCraft.botasdeZafiro){
