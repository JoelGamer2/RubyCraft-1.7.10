...
public class botasdeRuby extends ItemArmor {

	public botasdeRuby(ArmorMaterial armormaterial, int renderIdex, int armorType) {
	...
	if(stack.getItem() == RubyCraft.botasdeRuby){
