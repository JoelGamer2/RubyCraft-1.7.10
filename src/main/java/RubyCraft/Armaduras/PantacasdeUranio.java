...
public class PantacasdeUranio extends ItemArmor {

	public PantacasdeUranio(ArmorMaterial armormaterial, int renderIdex, int armorType) {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack stack){
		...
		if(stack.getItem() == RubyCraft.PantacasdeUranio){
