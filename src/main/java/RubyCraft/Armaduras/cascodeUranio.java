...
public class cascodeUranio extends ItemArmor {
	
	public static boolean LLevaArmadura = false;
	

	public cascodeUranio(ArmorMaterial armormaterial, int renderIdex, int armorType) {
