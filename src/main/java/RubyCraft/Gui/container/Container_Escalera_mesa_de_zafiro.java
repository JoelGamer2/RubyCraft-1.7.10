...
public class Container_Escalera_mesa_de_zafiro extends Container {
	...
	public Container_Escalera_mesa_de_zafiro(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, MesaZafiroManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != Escaleras_Principal.Escalera_de_Mesa_de_Trabajo_de_Zafiro) {
			return false;
		}else{
