...
public class gui_Container_Mesa_de_trabajo_abeto extends Container {
    ...
    public gui_Container_Mesa_de_trabajo_abeto(InventoryPlayer p_i1808_1_, World p_i1808_2_, int p_i1808_3_, int p_i1808_4_, int p_i1808_5_)
    {
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != RubyCraft.Mesa_de_trabajo_de_abeto) {
			return false;
		}else{
