...
public class ContainerMesadeTrabajodeZafiro extends Container {
	...
	public ContainerMesadeTrabajodeZafiro(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != RubyCraft.MesadeTrabajodeZafiro) {
			return false;
		}else{
