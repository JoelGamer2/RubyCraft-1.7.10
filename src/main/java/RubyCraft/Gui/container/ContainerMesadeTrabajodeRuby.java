...
public class ContainerMesadeTrabajodeRuby extends Container {
	...
	public ContainerMesadeTrabajodeRuby(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, MesarubyManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != RubyCraft.MesadeTrabajodeRuby) {
			return false;
		}else{
