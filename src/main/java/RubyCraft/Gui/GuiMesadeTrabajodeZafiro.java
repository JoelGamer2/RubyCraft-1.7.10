...
public class GuiMesadeTrabajodeZafiro extends GuiContainer {

	private ResourceLocation texture = new ResourceLocation(RubyCraft.modid + ":" + "textures/gui/Mesa_deTrabajo_de_Zafiro.png");
	
	public GuiMesadeTrabajodeZafiro(InventoryPlayer invPlayer, World world, int x, int y, int z) {
		super(new ContainerMesadeTrabajodeZafiro(invPlayer, world, x, y, z));
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		...
		this.fontRendererObj.drawString(StatCollector.translateToLocal("gui.Mesa_de_Zafiro.name"), 90, 80,  0x00219D);
