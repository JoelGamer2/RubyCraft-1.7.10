...
public class gui_mesadetrabajodeabedul extends GuiContainer {
    ...
    public gui_mesadetrabajodeabedul(InventoryPlayer p_i1084_1_, World p_i1084_2_, int p_i1084_3_, int p_i1084_4_, int p_i1084_5_)
    {
        super(new gui_Container_Mesa_de_trabajo_abedul(p_i1084_1_, p_i1084_2_, p_i1084_3_, p_i1084_4_, p_i1084_5_));
    }
