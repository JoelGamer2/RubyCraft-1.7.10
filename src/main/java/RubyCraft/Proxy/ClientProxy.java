...
import HerraCraft.Entidades.Render.PrakxisredstonerRenderModel;
...
import HerraCraft.Entidades.Render.RenderPrakxisredstonerTexture;
...
public class ClientProxy extends ServerProxy {
	...
	public void registerRenderThings(){
		...
		RenderingRegistry.registerEntityRenderingHandler(Prakxisredstoner.class, new RenderPrakxisredstonerTexture(new PrakxisredstonerRenderModel(), 0));
