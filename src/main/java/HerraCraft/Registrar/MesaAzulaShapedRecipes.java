...
public class MesaAzulaShapedRecipes implements IRecipe
{
    ...
    public MesaAzulaShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public MesaAzulaShapedRecipes func_92100_c()
    {
