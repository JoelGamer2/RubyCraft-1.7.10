...
public class ContainerMesadeAzula extends Container {
	...
	public ContainerMesadeAzula(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, Mesa_de_Azula_Manager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	}
	
	
	@Override
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != herracraft.Mesa_de_Azula) {
			return false;
		}else{
