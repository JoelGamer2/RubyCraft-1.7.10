...
public class Elemental_de_Tierra_Soldado extends EntityMob implements IBossDisplayData {

	public static int Fase = 0;
	private static int tick;
	public static boolean Activo;
	public Elemental_de_Tierra_Soldado(World world) {
		super(world);
	...
	/**Returns the sounds of ambient for the mob**/
	 protected String getLivingSound(){
	        ...
	        return RubyCraft.modid + ":elemental_ambiendte";
