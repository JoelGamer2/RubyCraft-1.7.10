...
public class Espada_de_Aguamarina_Amarilla extends ItemSword{

	public Espada_de_Aguamarina_Amarilla(ToolMaterial material) 
	{
		super(material);
	}
	...
	{
	return Clase_Principal_Evento_Verano.Aguamarina_Amarilla == par2ItemStack.getItem()? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
	}
}
