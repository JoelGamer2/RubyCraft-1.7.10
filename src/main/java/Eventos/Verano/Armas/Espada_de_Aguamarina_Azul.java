...
public class Espada_de_Aguamarina_Azul extends ItemSword{

	public Espada_de_Aguamarina_Azul(ToolMaterial material) 
	{
		super(material);
	}
	...
	{
	return Clase_Principal_Evento_Verano.Aguamarina_Azul == par2ItemStack.getItem()? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
	}
}
