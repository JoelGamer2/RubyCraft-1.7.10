...
public class Espada_de_Aguamarina_AzulOscuro extends ItemSword{

	public Espada_de_Aguamarina_AzulOscuro(ToolMaterial material) 
	{
		super(material);
	}
	...
	{
	return Clase_Principal_Evento_Verano.Aguamarina_AzulOscuro == par2ItemStack.getItem()? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
	}
}
